    ...
    steps: [
      {
        ...
        body: "翔大鋼業のホームページを調査し、彼らが函館の街の建物を頑丈に支えるために行っている、漢字2文字の『得意技（工事の名前）』を見つけ出せ！",
      ...
      },
      {
        ...
        body: "暗号の骨組みの中の12345ヒントから当てはまる単語を入れて①②③④⑤⑥⑦を見つけろ！",
        acceptedAnswers: ["技術力", "ぎじゅつりょく", "ギジュツリョク"],
        hints: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "一つ目のヒントで得た企業の公式サイトを見ながら下の言葉を完成させよ。",
        acceptedAnswers: ["Mの創発", "mの創発", "エムの創発", "えむのそうはつ", "Mのそうはつ", "DRB", "drb", "ディーアールビー"],
        hints: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "問題1　100万ドルのやけい　しおラーメン　カトリックきょうかい　916＝？",
  ...
  if (step.puzzleType === "dock-miniboss") {
    return `
      <div class="puzzle-panel dock-file dock-miniboss">
        ...
        <p>■に入る数字はなに？</p>
        <div class="month-difference-log" aria-label="数字の法則を読み取り、■に入る数字を求める問題">
          <div class="month-equation"><span>2</span><b>＝</b><strong>28</strong></div>
          <div class="month-equation"><span>7</span><b>－</b><span>6</span><strong>＝ 1</strong></div>
          <div class="month-equation"><span>9</span><b>－</b><span>2</span><strong>＝ 3</strong></div>
          <div class="month-equation is-locked"><span>12</span><b>－</b><span>5</span><strong>＝ ■</strong></div>
        </div>
      </div>
    `;
  }
